...
public class DateUtil {
	...
	public static final String FullDatePatternNoSymbol = "yyyyMMddHHmmss";
	
	public static final String FullTimePatternNoSymbol = "HHmmss";
	
	public static final String FullDateHourPattern = "yyyy-MM-dd HH";
